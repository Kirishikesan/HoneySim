...
Valve4=Valve(RetentionTank1,RetentionToStoragePipe1,16,1,0,0)
Valve5=Valve(RetentionTank2,RetentionToStoragePipe2,16,1,0,0)
Valve6=Valve(RetentionTank3,RetentionToStoragePipe3,16,1,0,0)
Pump2=Pump(StorageTank,StoragePumpToValve,16,1,0,1)
...
while(True):
    ...
    print ("Retention1, FlowIn: "+ str(RetentionTank1._flowIn))
