...
try:
    #c=ModbusClient(host="34.131.6.70", port=1500, unit_id=1, auto_open=True, debug=False)
    c=ModbusClient(host="192.168.8.182", port=5020, unit_id=1, auto_open=True, debug=False)
except ValueError:
